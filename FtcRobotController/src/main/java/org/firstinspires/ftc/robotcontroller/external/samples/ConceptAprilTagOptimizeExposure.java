...
public class ConceptAprilTagOptimizeExposure extends LinearOpMode {
	...
	public void runOpMode() {
		...
		// Establish Min and Max Gains and Exposure. Then set a low exposure with high
		// gain
		getCameraSetting();
	...
	/*
	 * Manually set the camera gain and exposure. Can only be called AFTER calling
	 * initAprilTag(); Returns true if controls are set.
	 */
	...
	/*
	 * Read this camera's minimum and maximum Exposure and Gain settings. Can only
	 * be called AFTER calling initAprilTag();
	 */
