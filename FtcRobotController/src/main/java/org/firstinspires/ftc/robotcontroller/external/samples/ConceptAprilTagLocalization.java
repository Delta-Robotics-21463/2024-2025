...
public class ConceptAprilTagLocalization extends LinearOpMode {
	 ...
	 * Setting these values requires a definition of the axes of the camera and
	 * robot:
	 *
	 * <p>
	 * Camera axes: Origin location: Center of the lens Axes orientation: +x right,
	 * +y down, +z forward (from camera's perspective)
	 *
	 * <p>
	 * Robot axes (this is typical, but you can define this however you want):
	 * Origin location: Center of the robot at field height Axes orientation: +x
	 * right, +y forward, +z upward
	 *
	 * <p>
	 * Position: If all values are zero (no translation), that implies the camera is
	 * at the center of the robot. Suppose your camera is positioned 5 inches to the
	 * left, 7 inches forward, and 12 inches above the ground - you would need to
	 * set the position to (-5, 7, 12).
	 *
	 * <p>
	 * Orientation: If all values are zero (no rotation), that implies the camera is
	 * pointing straight up. In most cases, you'll need to set the pitch to -90
	 * degrees (rotation about the x-axis), meaning the camera is horizontal. Use a
	 * yaw of 0 if the camera is pointing forwards, +90 degrees if it's pointing
