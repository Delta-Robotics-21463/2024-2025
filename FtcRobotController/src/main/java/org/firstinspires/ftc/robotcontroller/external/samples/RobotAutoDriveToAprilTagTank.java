...
public class RobotAutoDriveToAprilTagTank extends LinearOpMode {
	...
	// larger for a more
	// aggressive response.
	final double SPEED_GAIN = 0.02; // Speed Control "Gain". e.g. Ramp up to 50% power at a 25 inch error. (0.50 /
									// 25.0)
	...
	public void runOpMode() {
		...
		// Note: The settings here assume direct drive on left and right wheels. Single
		// Gear Reduction
