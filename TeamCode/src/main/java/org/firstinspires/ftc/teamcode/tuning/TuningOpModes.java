...
public final class TuningOpModes {
  ...
  public static void register(OpModeManager manager) {
    ...
    manager.register(
        metaForClass(MecanumMotorDirectionDebugger.class), new MecanumMotorDirectionDebugger(dvf));
    manager.register(
        metaForClass(DeadWheelDirectionDebugger.class), new DeadWheelDirectionDebugger(dvf));
            ...
            configRoot -> {
              for (Class<?> c :
                ...
                configRoot.putVariable(
                    c.getSimpleName(), ReflectionConfig.createVariableFromClass(c));
              }
            });
  }
}
